...
export const WHALES = {
  ...
  arbitrum: [
    ...
    '0xe9e6b9aAAfaf6816C3364345F6eF745CcFC8660a', // tBTC whale
    ...
    '0xBA12222222228d8Ba445958a75a0704d566BF2C8', // tETH whale
    '0xDe5319FF7AA503A412770C3d41BD27CF2AfD0d6F', // tETH whale
  ],
  base: [
    '0x6D3c5a4a7aC4B1428368310E4EC3bB1350d01455', // USDbC whale
    '0xB4885Bc63399BF5518b994c1d0C153334Ee579D0', // USDbC whale
    '0x58Ee32056D946a37f5b49582dE3dEE1dAc0Bb974', // USDbC whale
    '0x52e2230cDb80EDEBDaDafcf24033608C9A636D7D', // USDbC whale
    '0x4C36388bE6F416A29C8d8Eee81C771cE6bE14B18', // USDbC whale
    '0x2223F9FE624F69Da4D8256A7bCc9104FBA7F8f75', // USDbC whale
    ...
    '0xf81e1a62cBfA487E807044618661bFD4802B4982', // tBTC whale
    '0x9A858ebfF1bEb0D3495BB0e2897c1528eD84A218', // tBTC whale
    '0x488d6ea6064eEE9352fdCDB7BC50d98A7fF3AD4E', // tBTC whale
    '0xA33f162da19C7273BA1205BFD9D4340dA2446E3a', // tBTC whale
  ],
  scroll: [
  ...
  'unichain': [
    ...
    '0xA4531ABa9C8A2D34fF663D315347856b2a0BDAd4', // wstETH whale
    '0xEdd88CA63D7C0B9cF182aFDEE3852258F31961f9', // wstETH whale
    '0x54ff502df96CD9B9585094EaCd86AAfCe902d06A', // wstETH whale
    '0x6645983f870dEc453667BE719D8F9700a339B2a4', // ezETH whale
    '0x45b41B20B11cD2e71A6BF3021bdbc3F8aFEa5538', // ezETH whale
    '0x2dD432B98FE61c19425Ef3EF17D8cB3053F22699', // ezETH whale
    '0x8f5ae9CddB9f68de460C77730b018Ae7E04a140A', // ezETH whale
  ],
  linea: [
