...
export default async function deploy(deploymentManager: DeploymentManager, deploySpec: DeploySpec): Promise<Deployed> {
  ...
  // Deploy scaling price feed for sfrxETH
  const sfrxETHScalingPriceFeed = await deploymentManager.deploy(
    'sfrxETH:priceFeed',
    'pricefeeds/ScalingPriceFeed.sol',
    [
      '0x8f096bFFe37313Ad6bD5B9fF48F9FF6E4E5Cd065', // sfrxETH / ETH price feed
      8                                             // decimals
    ]
  );
