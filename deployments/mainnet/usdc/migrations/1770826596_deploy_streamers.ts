...
const MAX_REMOVE_FROM_USDC_VAULT = utils.parseUnits('1788506', 6);
...
const STREAMER_PARAMS = {
  WOOF: {
    ...
    remainingStreamAmount: utils.parseUnits('503920.78894', 6),
    remainingStreamTime: BigNumber.from(7945824),
  },
  SSP: {
    streamer: '0x334791289a906Ac8f96ac0f90E7A91Bf4AaE4A60',
    recipient: '0xa1fa21665daA59f27046110CC2f58218b6343A2B',
    remainingStreamAmount: utils.parseUnits('836994.712393', 6),
    remainingStreamTime: BigNumber.from(15083124),
  },
  ZERO_SHADOW: {
    streamer: '0xAF9CEE006AE377e88f3BBd668e3d67807F546Bd8',
    recipient: '0x9FAEaBCeD4C29F030d40A83F1a7822624d67f904',
    remainingStreamAmount: utils.parseUnits('119570.673199', 6),
    remainingStreamTime: BigNumber.from(15083124),
  },
  TALLY: {
    streamer: '0x36a0eB84154797DAdCEaCFD046785dB31094C308',
    recipient: '0x7E90E03654732ABedF89Faf87f05BcD03ACEeFdC',
    remainingStreamAmount: utils.parseUnits('64296.627664', 6),
    remainingStreamTime: BigNumber.from(13517724),
  },
  GAUNTLET: {
    streamer: '0xEA2B6BC719CF6D2Fed07865d26987D32d570DbBD',
    recipient: '0xD20c9667bf0047F313228F9fE11F8b9F8Dc29bBa',
    remainingStreamAmount: utils.parseUnits('964230.664321', 6),
    remainingStreamTime: BigNumber.from(18886944),
  }
};
